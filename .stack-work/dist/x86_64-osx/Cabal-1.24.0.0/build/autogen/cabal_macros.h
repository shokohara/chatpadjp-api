...
/* package chatpadjp-api-0.1.0.0 */
#define VERSION_chatpadjp_api "0.1.0.0"
#define MIN_VERSION_chatpadjp_api(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "chatpadjp-api-0.1.0.0-GNOU39oZhWLLgGQ7X1Tpf8"

#define CURRENT_PACKAGE_KEY "chatpadjp-api-0.1.0.0-GNOU39oZhWLLgGQ7X1Tpf8"
